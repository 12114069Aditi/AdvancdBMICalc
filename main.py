...
def BMI():
    ...
    #you can change value,because diff countries have diff index
    if bmi<=18.5:
...
#icon
image_icon=PhotoImage(file="images/bmiimage1.png")
...
#command to chnage baclground color of scale
style=ttk.Style()
...
weight.place(x=290,y=160)
Weight.set(get_current_value2())

#manimage
secondimage=Label(root,bg="lightblue")
secondimage.place(x=70,y=560)
